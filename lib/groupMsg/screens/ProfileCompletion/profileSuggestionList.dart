...
import 'package:ofy_flutter/groupMsg/screens/AddNewGroupScreen.dart';
...
class _ContactListScreenState extends State<ContactListScreen>
{
  ...
  List<gUser> getListOfUsers(List<String> userNames, List<gUser> userList)
  {
    List<gUser> users = new List<gUser>();
  ...
  Widget build(BuildContext context)
  {
    ...
    List<gUser> queriedUserList = [];

    userList.forEach((user){
      if(user.uid != currentUserID && user_interests.contains(user.username))
        {
