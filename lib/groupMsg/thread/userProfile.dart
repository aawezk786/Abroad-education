...
import 'package:ofy_flutter/groupMsg/thread/subViews/changeUserIcon.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          width: 40,
                          height: 40,
                          child:  Image.network(widget.myData.myThumbnail)
                        ),
                        Padding(
              ...
              GestureDetector(
                ...
                child: Text('Name:'+CurrentUser.user.username,style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),)
              ),
            ],
          )
        ),
