...
//          ),
          ...
          backgroundColor: arr1.contains(categories[index]) ? Theme.of(context).brightness == Brightness.light ? Colors.black : Colors.white : Theme.of(context).brightness == Brightness.light ? Color(0xffE8E8E8) : Colors.black,
...
//          ) : null,
          label: Text(categories[index],style: TextStyle(color: arr1.contains(categories[index]) ? Theme.of(context).brightness == Brightness.light ? Colors.white : Colors.black : Theme.of(context).brightness == Brightness.light ? Colors.black : Colors.white,fontSize: 17.0)),
        ),
      ));
    }
    return temp;
...
//                                SnackBar(content: Text('Please select a valid category'),action: SnackBarAction(label: "OK",onPressed: (){},),),
//                              );
                            } else {
